...
class UpdatePharmacyStock(models.TransientModel):
    ...
    prescription_id = fields.Many2one('pharmacy.prescription', 'Prescription', default=lambda self: self.env.context.get('active_id'))
    ...
    def update_stock(self):
        ...
        for line in self.medicine_lines:
            if line.quantity:
                if line.product_id.virtual_available < line.quantity:
